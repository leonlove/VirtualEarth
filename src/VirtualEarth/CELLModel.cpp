...
namespace   CELL
{
	...
	void Model::Draw(CELLProgram &shader)
	{
	...
	CELL::Mesh Model::processMesh(aiMesh *mesh, const aiScene *scene)
	{
		// data to fill
	...
	std::vector<CELL::Texture> Model::loadMaterialTextures(aiMaterial *mat, aiTextureType type, string typeName)
	{
